...
const SettingsScreen: React.FC<SettingsProps> = ({ themeContext }) => {
  ...
  const handleSaveConfig = () => {
      ...
      // Visual feedback is handled by the button state and text below
  };
    ...
    <div className="animate-fade-in pb-10 relative">
      ...
      <div className="mx-4 mt-2 mb-6 p-4 bg-white dark:bg-[#1c1c1e] rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 flex flex-col gap-4">
          <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white shadow-lg shadow-indigo-500/20">
                  {userProfile.name ? (
            ...
            <div key={habit.id} className="flex items-center justify-between p-4 bg-white dark:bg-[#1c1c1e]">
                <div className="flex items-center gap-3 overflow-hidden flex-1">
                     <button 
                        ...
                        className="p-2 -ml-2 text-gray-400 dark:text-gray-500 hover:text-red-500 dark:hover:text-red-400 transition-colors rounded-full active:bg-gray-100 dark:active:bg-gray-800"
                     >
      ...
      <div className="rounded-xl overflow-hidden shadow-sm bg-white dark:bg-[#1c1c1e] divide-y divide-gray-100 dark:divide-gray-800">
        ...
        {!isAdmin ? (
            showAdminLogin ? (
                 <form onSubmit={handleAdminAction} className="p-4 flex flex-col gap-2 bg-gray-50 dark:bg-black/50 animate-fade-in">
                    ...
                    <div className="flex gap-2">
                        <input 
                            ...
                            className="flex-1 p-3 rounded-xl bg-white dark:bg-[#2c2c2e] dark:text-white border border-gray-200 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                            autoFocus
                        />
                        <button type="submit" className="px-5 bg-indigo-600 text-white rounded-xl font-bold">
                            Unlock
                        </button>
                    </div>
                </form>
                    ...
                    <div>
                        ...
                        <div className="flex gap-2">
                            <input 
                                ...
                                className="flex-1 p-2 rounded-lg bg-white dark:bg-[#2c2c2e] border border-gray-200 dark:border-gray-700 text-xs dark:text-white"
                            />
                            {configSheetUrl && (
                                <button 
                                    onClick={() => window.open(configSheetUrl, '_blank')}
                                    className="p-2 bg-green-100 dark:bg-green-900/30 text-green-600 rounded-lg"
                                    title="Open Sheet"
                                >
            ...
            <div className="relative w-full max-w-xs bg-white dark:bg-[#1c1c1e] rounded-2xl shadow-2xl p-6 animate-scale-press text-center">
                ...
                <div className="flex gap-3">
                    ...
                    <button 
                        ...
                        className="flex-1 py-2.5 rounded-xl bg-red-600 text-white font-semibold shadow-lg shadow-red-600/30"
                    >
                        Confirm
                    </button>
                </div>
